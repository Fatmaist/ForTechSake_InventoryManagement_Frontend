  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const uniqueIdDataBarangCount = uniqueIdDataBarang.size;
        setDataBarangCount(uniqueIdDataBarangCount);
      } catch (error) {
    ...
    <VStack width="100%" bg="gray.200" p="4" mb="4">
      ...
      <VStack spacing="16" align="center" height="100vh" justifyContent="center">
        <HStack spacing="20">
          ...
          >
            <Text fontSize="xl" fontWeight="bold" textAlign="center">
              Total Banyak Jenis Data Barang
            </Text>
        ...
        <HStack spacing="20">
          ...
          >
            <Text fontSize="xl" fontWeight="bold" textAlign="center">
              Total Permintaan Barang Keluar
            </Text>
            <Text fontSize="100px" fontWeight="bold">
              {dataBarangCount}
            </Text>
          ...
          >
            <Text fontSize="xl" fontWeight="bold" textAlign="center">
              Total Permintaan Restock Barang
            </Text>
            <Text fontSize="100px" fontWeight="bold">
              {dataBarangCount}
            </Text>
